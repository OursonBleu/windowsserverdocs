...
To use this setting, select **Enabled**. Then in **Options** under **Configure automatic updating**, select one of the options (**2**, **3**, **4**, **5**, or **7**).
